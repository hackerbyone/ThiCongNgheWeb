...
const Manufacturers = () => {
    ...
    const openModal = (manufacturer = null) => {
        if (manufacturer) {
            ...
            setFormData({
                name: manufacturer.name, description: manufacturer.description || '',
                website: manufacturer.website || '', phone: manufacturer.phone || '',
            });
        } else {
                                    ...
                                    <table className="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Website</th>
                                                <th>Điện thoại</th>
                                                {isAdmin && isAdmin() && <th style={{ width: '120px' }}>Thao tác</th>}
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {manufacturers.length === 0 ? (
                                                <tr>
                                                    <td colSpan={isAdmin && isAdmin() ? 6 : 5} className="text-center text-muted">
