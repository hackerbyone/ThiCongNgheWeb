                                ...
                                <table className="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Tên danh mục</th>
                                            <th>Mô tả</th>
                                            {isAdmin && isAdmin() && <th style={{ width: '150px' }}>Thao tác</th>}
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {categories.length === 0 ? (
                                            <tr>
                                                <td colSpan={isAdmin && isAdmin() ? 4 : 3} className="text-center">
                                            ...
                                            categories.map(category => (
                                                <tr key={category.id}>
                                                    ...
                                                    {isAdmin && isAdmin() && (
                                                        <td>
                                                            <button className="btn btn-sm btn-info mr-1" onClick={() => openModal(category)}>
