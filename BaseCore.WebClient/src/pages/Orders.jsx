...
const Orders = () => {
    ...
    useEffect(() => {
        loadOrders();
    }, [page, statusFilter, appliedStart, appliedEnd]);
    ...
    const handleApprove = async (orderId) => {
        ...
        try {
            ...
            await Promise.all([loadOrders(), loadStats(), loadRevenueSummary()]);
        } catch (error) {
    ...
    const buildOrdersChartData = () => {
        ...
        return {
            ...
            datasets: [
                {
                    label: 'Hoàn thành',
                    data: revenueSummary.ordersByDay.map(d => d.completed),
                    backgroundColor: '#28a745',
                    stack: 'orders',
                },
                {
                    label: 'Đang xử lý',
                    data: revenueSummary.ordersByDay.map(d => d.processing),
                    backgroundColor: '#17a2b8',
                    stack: 'orders',
                },
                {
                    label: 'Chờ duyệt',
                    data: revenueSummary.ordersByDay.map(d => d.pending),
                    backgroundColor: '#ffc107',
                    stack: 'orders',
                },
                {
                    label: 'Đã hủy/Từ chối',
                    data: revenueSummary.ordersByDay.map(d => d.cancelled + d.rejected),
        ...
        <div className="content-wrapper">
            ...
            <section className="content">
                <div className="container-fluid">
                    ...
                    <div className="card card-outline card-primary mb-3">
                        <div className="card-header">
                            <h3 className="card-title">
                                <i className="fas fa-filter mr-2"></i>Bộ lọc thời gian
                            </h3>
                        </div>
                    ...
                    {/* Thống kê nhanh theo khoảng thời gian đã chọn */}
                    {revenueSummary && (
                                                            ...
                                                            return (
                                                                <tr key={order.id}>
                                                                    ...
                                                                    <td className="text-center">
                                                                        <span className={`badge badge-${cfg.badge} px-2 py-1`}>
                                                                            {cfg.label}
                                                                        </span>
                                                                    </td>
                                                                    <td className="text-center">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-8 col-12 mb-4">
                                            <div className="card card-outline card-success mb-0">
                                                <div className="card-header">
                                                    <h3 className="card-title">
                                                        <i className="fas fa-chart-area mr-2 text-success"></i>
                                                        Doanh thu theo ngày
                                                    </h3>
                                                ...
                                                <div className="card-body">
                                                    {revenueChartData ? (
                                                        ...
                                                        <div className="text-center py-4 text-muted">
                                                            <i className="fas fa-chart-area fa-3x mb-3 d-block opacity-50"></i>
                                        ...
                                        {/* Biểu đồ tỉ lệ trạng thái */}
                                        <div className="col-lg-4 col-12 mb-4">
                                            <div className="card card-outline card-info mb-0">
                                                <div className="card-header">
                                                    <h3 className="card-title">
                                                        <i className="fas fa-chart-pie mr-2 text-info"></i>
                                                        Phân bổ trạng thái
                                                    </h3>
                                                </div>
                                                <div className="card-body">
                                                    {doughnutData ? (
                                                        ...
                                                        <div className="text-center py-4 text-muted">
                                                            <i className="fas fa-chart-pie fa-3x mb-3 d-block opacity-50"></i>
                                                            Không có dữ liệu
                                                        </div>
                                                    )}
                                                </div>
                                        ...
                                        {/* Biểu đồ đơn hàng theo ngày (stacked bar) */}
                                        <div className="col-12 mb-4">
                                            <div className="card card-outline card-primary mb-0">
                                                <div className="card-header">
                                                    ...
                                                    <div className="card-tools">
                                                        <span className="badge badge-secondary">Tất cả trạng thái</span>
                                                    </div>
                                                </div>
                                                <div className="card-body">
                                                    {ordersChartData ? (
                                                            ...
                                                            <tbody>
                                                                {Object.entries({
                                                                    ...
                                                                    return (
                                                                        <tr key={key}>
                                                                            <td>
                                                                                <span className={`badge badge-${cfg.badge} mr-2`}>{cfg.label}</span>
                                                                            </td>
